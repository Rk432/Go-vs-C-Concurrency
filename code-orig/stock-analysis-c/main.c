...
int main()
{
    ...
    read_csv("../../tests/stock_data/CompanyA_stock_prices.csv", companyA_data);
    read_csv("../../tests/stock_data/CompanyB_stock_prices.csv", companyB_data);
    read_csv("../../tests/stock_data/CompanyC_stock_prices.csv", companyC_data);
    read_csv("../../tests/stock_data/CompanyD_stock_prices.csv", companyD_data);
    read_csv("../../tests/stock_data/CompanyE_stock_prices.csv", companyE_data);
    ...
    char command[100];
    sprintf(command, "pmap -x %u > ../../results/memory-C.txt", getpid());
    int status = system(command);

    createLineChart(macd_results[0], 450, "../../results/c-macd/CompanyA_MACD_C.png");
    createLineChart(macd_results[1], 450, "../../results/c-macd/CompanyB_MACD_C.png");
    createLineChart(macd_results[2], 450, "../../results/c-macd/CompanyC_MACD_C.png");
    createLineChart(macd_results[3], 450, "../../results/c-macd/CompanyD_MACD_C.png");
    createLineChart(macd_results[4], 450, "../../results/c-macd/CompanyE_MACD_C.png");
