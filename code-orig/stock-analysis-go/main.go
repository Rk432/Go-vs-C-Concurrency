...
func main() {
	...
	companyAData := csvparser.ReadCSV("../../tests/stock_data/CompanyA_stock_prices.csv", 450)
	companyBData := csvparser.ReadCSV("../../tests/stock_data/CompanyB_stock_prices.csv", 450)
	companyCData := csvparser.ReadCSV("../../tests/stock_data/CompanyC_stock_prices.csv", 450)
	companyDData := csvparser.ReadCSV("../../tests/stock_data/CompanyD_stock_prices.csv", 450)
	companyEData := csvparser.ReadCSV("../../tests/stock_data/CompanyE_stock_prices.csv", 450)
	...
	command := fmt.Sprintf("pmap -x %d > ../../results/memory-Go.txt", os.Getpid())
	...
	err = plotchart.PlotMACDChart(macdResults[0], "../../results/go-macd/CompanyA_MACD.png")
	if err != nil {
		fmt.Println("Error plotting MACD chart:", err)
	}
	err = plotchart.PlotMACDChart(macdResults[1], "../../results/go-macd/CompanyB_MACD.png")
	if err != nil {
		fmt.Println("Error plotting MACD chart:", err)
	}
	err = plotchart.PlotMACDChart(macdResults[2], "../../results/go-macd/CompanyC_MACD.png")
	if err != nil {
		fmt.Println("Error plotting MACD chart:", err)
	}
	err = plotchart.PlotMACDChart(macdResults[3], "../../results/go-macd/CompanyD_MACD.png")
	if err != nil {
		fmt.Println("Error plotting MACD chart:", err)
	}
	err = plotchart.PlotMACDChart(macdResults[4], "../../results/go-macd/CompanyE_MACD.png")
	if err != nil {
		fmt.Println("Error plotting MACD chart:", err)
	}
